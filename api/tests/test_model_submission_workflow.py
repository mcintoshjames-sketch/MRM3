...
def test_create_model_as_admin_auto_approved(client, admin_headers, admin_user, usage_frequency):
...
def test_create_model_as_user_pending_approval(client, auth_headers, test_user, usage_frequency):
...
def test_user_can_edit_pending_model(client, auth_headers, test_user, usage_frequency, db_session):
...
def test_non_admin_cannot_approve_pending_edit(client, auth_headers, admin_headers, test_user, usage_frequency, db_session):
...
def test_non_admin_cannot_reject_pending_edit(client, auth_headers, admin_headers, test_user, usage_frequency, db_session):
...
def test_admin_approve_model(client, admin_headers, test_user, usage_frequency, db_session):
...
def test_admin_send_back_model(client, admin_headers, test_user, usage_frequency, db_session):
...
def test_user_resubmit_model(client, auth_headers, test_user, usage_frequency, db_session):
...
def test_submission_thread_retrieval(client, auth_headers, test_user, usage_frequency, db_session):
...
def test_full_submission_workflow_integration(client, auth_headers, admin_headers, test_user, usage_frequency, db_session):
    """
...
def test_user_cannot_approve_own_model(client, auth_headers, test_user, usage_frequency, db_session):
...
def test_dashboard_news_feed(client, auth_headers, test_user, usage_frequency, db_session):
...
def test_create_model_enforces_user_inclusion(client, auth_headers, second_user, usage_frequency):
