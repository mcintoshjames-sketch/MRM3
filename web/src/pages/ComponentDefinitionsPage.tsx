                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <p className="text-gray-600 mt-2">
                                Manage validation component expectations for different risk tiers. Changes require publishing a new configuration version.
                            </p>
                        </div>
                        <button
                ...
                {showPublishModal && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4">
                            <div className="p-6">
                                <h2 className="text-2xl font-bold mb-4">Publish New Configuration Version</h2>
                                <p className="text-gray-600 mb-6">
                                    Publishing a new configuration will snapshot the current component definitions.
                                    New validation plans will use this configuration. Existing locked plans will remain linked to their original configuration.
                                </p>
