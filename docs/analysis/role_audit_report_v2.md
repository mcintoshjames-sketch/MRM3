...
*Generated on: 2025-12-31 18:18:19*

## Executive Summary

- **Total API Endpoints Analyzed**: 550
- **Total Features/Modules**: 47
- **Canonical Roles**: 5
- **Authorization Patterns Detected**: 9
...
| Methodology | — | — | — | — | — |
| Model Applications | ✅ (3) | — | — | — | ✅ (3) |
| Model Change Taxonomy | — | — | — | — | — |
| Model Decommissioning | ✅ (6) | ✅ (2) | ✅ (2) | — | ✅ (2) |
| Model Delegates | ✅ (2) | — | — | — | — |
...
| Performance Monitoring | ✅ (11) | ✅ (2) | ✅ (2) | — | ✅ (1) |
| Qualitative Factors | — | — | — | — | — |
| Recommendations | ✅ (23) | ✅ (1) | ✅ (1) | — | ✅ (1) |
...
**Exclusive Capabilities** (126 endpoints):
...
- `GET /records/{attestation_id}`
- `GET /records/{attestation_id}/linked-changes`
- `POST /records/{attestation_id}/evidence`
- *(+1 more endpoints)*
...
- `POST /{recommendation_id}/rebuttal`
...
- `GET /dashboard/recent-approvals`
...
- **VALIDATOR**: 6 endpoint(s)

**Sample Endpoints**:
- `GET /admin/linked-changes` — ADMIN, VALIDATOR
...
- **ADMIN**: 3 endpoint(s)
- **ALL_AUTHENTICATED**: 1 endpoint(s)
- **VALIDATOR**: 3 endpoint(s)

**Sample Endpoints**:
- `GET ` — Any authenticated
- `POST ` — ADMIN, VALIDATOR
- `PATCH /{application_id}` — ADMIN, VALIDATOR
- `DELETE /{application_id}` — ADMIN, VALIDATOR
...
- **ADMIN**: 6 endpoint(s)
- **ALL_AUTHENTICATED**: 6 endpoint(s)
- **GLOBAL_APPROVER**: 2 endpoint(s)
- **REGIONAL_APPROVER**: 2 endpoint(s)
- **VALIDATOR**: 2 endpoint(s)

**Sample Endpoints**:
- `POST /` — Any authenticated
- `GET /` — Any authenticated
- `GET /models/{model_id}/implementation-date` — Any authenticated
- `GET /my-pending-approvals` — ADMIN, GLOBAL_APPROVER, REGIONAL_APPROVER
...
- `GET /monitoring/approvals/my-pending` — ADMIN, GLOBAL_APPROVER, REGIONAL_APPROVER
...
- **Validator Check**: 17 occurrence(s)
- **Row-level security filters applied**: 11 occurrence(s)
- **Global Approver Check**: 7 occurrence(s)
- **Regional Approver Check**: 7 occurrence(s)
